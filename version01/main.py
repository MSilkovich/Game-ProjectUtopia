...
def saveGame():
    ...
    maxdays = cur.execute("""SELECT maxdays FROM resourses""").fetchall()
...
def global_changes():
    ...
    if round(food - population) > 500 and happiness < 100 and limit > population:
        happiness += 0.1
        ...
        if self.mouse_in(mousePos):
            ...
            if pygame.mouse.get_pressed()[0] and self.mouse_in(mousePos):
                ...
                if food >= 300 and wood >= 225:
                    ...
                    can_build = False
                    grids[board.grid_pos] = False
                    structures.append((university, self.pos[0], self.pos[1], self.cell, 'university'))
