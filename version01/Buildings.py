import pygame as pg
from SETTINGS import MYEVENTTYPE_farm, MYEVENTTYPE_ironmine, MYEVENTTYPE_ironmine_anim, MYEVENTTYPE_quarry
...
class Quarry(pg.sprite.Sprite):
    ...
    def update(self):
        if self.m < 2:
            ...
            pg.time.set_timer(MYEVENTTYPE_quarry, 100)
